DHUD_CommandList = {
    ...
    ["fontsizetargettargetname"] = {
                    ["type"]     = "range",
                    ["command"]  = "fontsizetargettargetname",
                    ["minvalue"] = 1,
                    ["maxvalue"] = 30,
                },
    ["fontsizetarget"] = {
    ...
    ["showtargettarget"] = {
                    ["type"]     = "toggle",
                    ["command"]  = "showtargettarget",
                },
    ["showplayerbuff"] = {
                    ["type"]     = "toggle",
                    ["command"]  = "showplayerbuff",
                },
    ["showpet"] = {
                    ["type"]     = "toggle",
                    ["command"]  = "showpet",
    ...
    ["playerbuffoutline"] = {
                    ["type"]     = "range",
                    ["command"]  = "playerbuffoutline",
                    ["minvalue"] = 0,
                    ["maxvalue"] = 2,
                },
    ["playerbufftimefilter"] = {
                    ["type"]     = "range",
                    ["command"]  = "playerbufftimefilter",
                    ["minvalue"] = 0,
                    ["maxvalue"] = 3600,
                },
}
