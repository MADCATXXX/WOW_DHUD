...
L["SETTING_BLIZZARD_SPELLACTIVATION"] = "Непрозр. актив. закл.";
L["SETTING_BLIZZARD_SPELLACTIVATION_TOOLTIP"] = "Изменить непрозрачность стандартной панели активации заклинаний";
...
L["SETTING_HEALTHBAR_SHIELDS_TOOLTIP"] = "Позволяет показывать сумму эффектов щита здоровья на панели и в тексте";
...
L["SETTING_LAYOUTS_DATA_SOURCES"] = {
	...
	["characterInVehicleHealth"] = "Player: Здоровье персонажа в машине",
