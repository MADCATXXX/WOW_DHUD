...
L["SETTING_HEALTHBAR_HEALTHREDUCE"] = "Уменьшен. здоровья";
L["SETTING_HEALTHBAR_HEALTHREDUCE_TOOLTIP"] = "Позволяет показывать сумму эффектов уменьшения здоровья (напр. Удушающие испарения в вылазках) на панели и в тексте";
...
L["SETTING_COLORS_PLAYER_HEALTHMAXREDUCE"] = "Уменьш. здовровья";
L["SETTING_COLORS_PLAYER_HEALTHMAXREDUCE_TOOLTIP"] = "Цвет, который должен быть использован на панели и в тексте при отображении Временно Уменьшенного Здоровья Игрока";
...
L["SETTING_COLORS_TARGET_HEALTHMAXREDUCE"] = "Уменьш. здовровья";
L["SETTING_COLORS_TARGET_HEALTHMAXREDUCE_TOOLTIP"] = "Цвет, который должен быть использован на панели и в тексте при отображении Временно Уменьшенного Здоровья Цели";
...
L["SETTING_COLORS_PET_HEALTHMAXREDUCE"] = "Уменьш. здовровья";
L["SETTING_COLORS_PET_HEALTHMAXREDUCE_TOOLTIP"] = "Цвет, который должен быть использован на панели и в тексте при отображении Временно Уменьшенного Здоровья Питомца";
...
L["SETTING_COLORS_ALTERNATIVEPOWER_INSANITY"] = "Безумие";
L["SETTING_COLORS_ALTERNATIVEPOWER_INSANITY_TOOLTIP"] = "Цвет, который должен быть использован на панели и в тексте при отображении Безумия Игрока";
...
L["HEADER_COLORS_TARGETALTERNATIVEPOWER"] = "Альтерн. рес. цели:";

L["SETTING_COLORS_TARGETALTERNATIVEPOWER_ECLIPSE"] = "Затмение";
L["SETTING_COLORS_TARGETALTERNATIVEPOWER_ECLIPSE_TOOLTIP"] = "Цвет, который должен быть использован на панели и в тексте при отображении Затмения Цели";

L["SETTING_COLORS_TARGETALTERNATIVEPOWER_MAELSTROM"] = "Эн. Круговорота";
L["SETTING_COLORS_TARGETALTERNATIVEPOWER_MAELSTROM_TOOLTIP"] = "Цвет, который должен быть использован на панели и в тексте при отображении Энергии Круговорота Цели";

L["SETTING_COLORS_TARGETALTERNATIVEPOWER_FURY"] = "Ярость";
L["SETTING_COLORS_TARGETALTERNATIVEPOWER_FURY_TOOLTIP"] = "Цвет, который должен быть использован на панели и в тексте при отображении Ярости Цели";

L["SETTING_COLORS_TARGETALTERNATIVEPOWER_PAIN"] = "Боль";
L["SETTING_COLORS_TARGETALTERNATIVEPOWER_PAIN_TOOLTIP"] = "Цвет, который должен быть использован на панели и в тексте при отображении Боли Цели";

L["SETTING_COLORS_TARGETALTERNATIVEPOWER_INSANITY"] = "Безумие";
L["SETTING_COLORS_TARGETALTERNATIVEPOWER_INSANITY_TOOLTIP"] = "Цвет, который должен быть использован на панели и в тексте при отображении Безумия Цели";
...
L["SETTING_SERVICE_SOFTTARGET"] = "Режим динамич. цели";
L["SETTING_SERVICE_SOFTTARGET_TOOLTIP"] = "Изменение для приоритизации динамической цели перед фиксированной целью (см. Параметры Бой Разрешить динамическое выделение)";
